...
// Sensitivity: Adress: 0x4A, value: 0 - 255 in hex
// Negative Inertia: Adress: 0x4D, value: 0 - 255 in hex
// Press to select: Adress: 0x2X, value: 0 (disabled) or 1 (enabled) in hex (0x00 or 0xFF)

// void ps2_mouse_init_user() {
//     PS2_MOUSE_SEND(0xE2) //enable writing on the Trackpoint
//     PS2_MOUSE_SEND(0x81) //enable writing on the Trackpoint
//     PS2_MOUSE_SEND(0x2X)
//     PS2_MOUSE_SEND(0xFF)
// }
